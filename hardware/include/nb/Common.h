...
const static double MOTION_FRAME_LENGTH_S = 0.01;
// 1 second * 1000 ms/s * 1000 us/ms
const double MOTION_FRAME_LENGTH_uS = 1000.0 * 1000.0 * MOTION_FRAME_LENGTH_S;
const double MOTION_FRAME_RATE = 1.0 / MOTION_FRAME_LENGTH_S;
